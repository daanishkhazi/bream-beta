...
export default function Chat({ machines }: ChatProps) {
  ...
  const handleSendMessage = async () => {
    ...
    const userMessage: Message = {
      role: "user",
      content:
        "Please answer the following in a concise and tactical way. Rather than list out several options, give your suggested action with possibly an alternative or two: " +
        input,
    };
